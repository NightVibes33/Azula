...
private extension UTType {
    static let azulaIPA = UTType(
        importedAs: "com.nightvibes33.azula.ipa",
        conformingTo: .archive
    )

    static let azulaDylib = UTType(
        importedAs: "com.nightvibes33.azula.dylib",
...
struct FilePickerView: View {
                ...
                GeometryReader { geometry in
                    ...
                    ScrollView {
                        VStack(spacing: compact ? 14 : 18) {
                            ...
                            AzulaSectionHeader(title: "Target", subtitle: "Only .ipa files are selectable.")
                            ...
                            AzulaSectionHeader(title: "Injected Libraries", subtitle: "Only .dylib files are selectable.")
                            ...
                            AzulaCard {
                                VStack(alignment: .leading, spacing: 14) {
                                    ...
                                    .fileImporter(
                                        ...
                                        allowedContentTypes: [.azulaDylib],
                            ...
                            AzulaCard {
                                HStack(alignment: .top, spacing: 12) {
                                    ...
                                    Text("Azula declares .ipa and .dylib as supported document types, so Files can recognize the extensions before selection. Azula validates the extension again before copying anything into its sandbox.")
                                        .font(.footnote)
                                        .foregroundStyle(AzulaTheme.secondaryText)
                                        .fixedSize(horizontal: false, vertical: true)
                                }
    ...
    private func validateSelectedFile(
        ...
        do {
            ...
            // Remote providers may defer metadata until security-scoped access starts.
            // The coordinated copy below remains the authoritative read.
        }
